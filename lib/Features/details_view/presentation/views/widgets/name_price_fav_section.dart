...
class NamePriceFavSection extends StatelessWidget {
  const NamePriceFavSection({super.key, required this.menModel});
    ...
    return Row(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            Text(menModel.price, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 6),
            Row(
              children: [
                const Icon(Icons.favorite_border, size: 18),
                const SizedBox(width: 4),
                Text("450", style: AppStyles.styleMedium14(context)),
              ],
            ),
          ],
        ),
